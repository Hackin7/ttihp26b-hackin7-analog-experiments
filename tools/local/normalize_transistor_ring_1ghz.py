"""Origin-normalize the 1 GHz transistor ring for LibreLane.
...
ring_oscillator_1ghz (distinct from the 100 MHz leaf).
"""
...
MACRO = ROOT / "analog/transistor_ring_oscillator_1ghz/macro"
SOURCE_GDS = MACRO / "main_fixed.gds"
SOURCE_LEF = MACRO / "ring_oscillator.lef"
OUTPUT_GDS = MACRO / "ring_oscillator_1ghz.gds"
OUTPUT_LEF = MACRO / "ring_oscillator_1ghz.lef"
EXTRACTED_SPICE = MACRO / "ring_oscillator_extracted.spice"
OUTPUT_SPICE = MACRO / "ring_oscillator_1ghz.spice"

CELL_NAME = "ring_oscillator_1ghz"
...
PIN_OUT_M1 = (13.520, 2.130, 14.520, 3.130)
